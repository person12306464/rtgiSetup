...
#Used to check if the program was run as admin but windows defender o___o
#try:
...
newpath = resource_path(r"RTGI")
os.makedirs(newpath)
print("Made folder to extract to")

#Extract it
with ZipFile(resource_path('ReShade_RTGI_0.36.1.zip'), 'r') as zip_object:
    zip_object.extractall(resource_path("RTGI"))
print("Extracted the zip")


#Rename and duplicate files
os.rename(resource_path('RTGI\\Shaders\\qUINT_rtgi.fx'), resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx'))
print("Renamed file")

os.rename(resource_path('RTGI\\Textures\\bluenoise.png'), resource_path('RTGI\\Textures\\rtgibluenoise.png'))
...
fileNameR1 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumberR1 = 19
textR1 = ""
...
fileNameR2 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumberR2 = 20
textR2 = ""
...
fileNameR3 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumberR3 = 21
textR3 = ""
...
fileName1 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber1 = 28
...
fileName2 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber2 = 32
...
fileName3 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber3 = 36
...
fileName4 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber4 = 40
...
fileName5 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber5 = 44
...
fileName6 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber6 = 44
...
fileName7 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber7 = 361
...
fileName8 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber8 = 61
...
fileName9 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber9 = 66
text9 = "> = 50.0;"
...
fileName10 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber10 = 70
...
fileName12 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber12 = 75
text12 = "> = 10.0;"
...
fileName13 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber13 = 79
...
fileName14 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber14 = 83
text14 = "> = 3;"
...
fileName15 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber15 = 87
...
fileName16 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber16 = 91
text16 = "> = 55;"
...
fileName17 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber17 = 100
text17 = "> = 0.08;"
...
fileName18 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber18 = 111
...
fileName19 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber19 = 116
text19 = "> = 1.0;"
...
fileName20 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber20 = 121
...
fileName21 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber21 = 125
text21 = "> = 0.1;"
...
fileName22 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber22 = 161
text22 = "> = 0.0;"
...
fileName23 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber23 = 169
text23 = "> = 0.0;"
...
fileName24 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber24 = 178
text24 = "> = 0.5;"
...
fileName25 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber25 = 186
text25 = "> = 2.0;"
...
fileName26 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber26 = 195
text26 = "> = 0.0;"
...
#fileName27 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
#lineNumber27 = 218
...
fileName28 = resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx')
lineNumber28 = 221
text28 = "> = 1.0;"
...
shutil.copy2(resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx'), resource_path('RTGI\\Shaders\\qUINT_rtgi_specular.fx'))
...
fileName29 = resource_path('RTGI\\Shaders\\qUINT_rtgi_specular.fx')
lineNumber29 = 116
text29 = "> = 0.5;"
...
newpath = resource_path(r"PUT IN ANSEL")
os.makedirs(newpath)
print("Made folder to put files in")

shutil.move(resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx'), resource_path('PUT IN ANSEL\\qUINT_rtgi_diffuse.fx'))
print("Moved diffuse")
shutil.move(resource_path('RTGI\\Shaders\\qUINT_rtgi_specular.fx'), resource_path('PUT IN ANSEL\\qUINT_rtgi_specular.fx'))
print("Moved specular")
shutil.move(resource_path('RTGI\\Shaders\\qUINT'), resource_path('PUT IN ANSEL\\qUINT'))
print("Moved qUINT folder")
shutil.move(resource_path('RTGI\\Textures\\rtgibluenoise.png'), resource_path('PUT IN ANSEL\\rtgibluenoise.png'))
...
#shutil.move(resource_path('RTGI\\Shaders\\qUINT_rtgi_diffuse.fx'), 'C:\\Program Files\\NVIDIA Corporation\\Ansel\\qUINT_rtgi_diffuse.fx')
#print("Moved diffuse")
#shutil.move(resource_path('RTGI\\Shaders\\qUINT_rtgi_specular.fx'), 'C:\\Program Files\\NVIDIA Corporation\\Ansel\\qUINT_rtgi_specular.fx')
#print("Moved specular")
#shutil.move(resource_path('RTGI\\Shaders\\qUINT'), 'C:\\Program Files\\NVIDIA Corporation\\Ansel\\qUINT')
#print("Moved qUINT folder")
#shutil.move(resource_path('RTGI\\Textures\\rtgibluenoise.png'), 'C:\\Program Files\\NVIDIA Corporation\\Ansel\\rtgibluenoise.png')
#print("Moved rtgibluenoise.png")

#Delete the RTGI directory
shutil.rmtree(resource_path('RTGI'))
...
shutil.rmtree(resource_path('PUT IN ANSEL'))
